...
export const photographers: Photographer[] = [
  {
    ...
    photos: [
      ...
      ...sessionFrames("nature-outdoors-places", 35, "Nature/Outdoors/Places", "Nature, outdoors, and places photograph"),
      ...sessionFrames("family-kids", 27, "Family/Kids", "Family and kids photograph"),
    ],
  },
  {
    id: "skylar",
    ...
    photos: [
      ...
      ...sessionFrames("cars", 14, "NorCal spots", "Car photograph"),
...
const shootPlan: { id: string; album: string; title: string; blurb: string }[] = [
  ...
  { id: "nature-outdoors-places", album: "Nature/Outdoors/Places", title: "Nature/Outdoors/Places", blurb: "Outside, and the places you go." },
  { id: "family-kids", album: "Family/Kids", title: "Family/Kids", blurb: "The kids, and the people who love them." },
];
...
export const clientGalleries: ClientGallery[] = [
  ...
  {
    id: "nature-outdoors-places",
    title: "Nature/Outdoors/Places",
    subtitle: "Outside, and the places you go.",
    photographerId: "patricia",
    code: "TFP-NATURE-2026",
    dateLabel: "Nature/Outdoors/Places",
    cover: "/images/nature-outdoors-places/01.jpg",
    photos: patricia.photos.filter((p) => p.album === "Nature/Outdoors/Places"),
    publicPreview: true,
  },
  {
    id: "family-kids",
    title: "Family/Kids",
    subtitle: "The kids, and the people who love them.",
    photographerId: "patricia",
    code: "TFP-FAMILY-KIDS-2026",
    dateLabel: "Family/Kids",
    cover: "/images/family-kids/01.jpg",
    photos: patricia.photos.filter((p) => p.album === "Family/Kids"),
    publicPreview: true,
  },
  {
    id: "wildflower-year",
